...
function _a1(b, a) {
    this.count = b;
    this._fc = a;this.__defineGetter__("Count", function() {
        return this.count
...
function _a3(k, l, h, g, f, e) {
    this._bs = k;
    this._ar = l;
    this._do = new Array(h, g, f, e);var j = 0;
    var b = h._bo;
    var a = h._fb();
    ...
    this._br = j;this.__defineGetter__("_fd", function() {
        return this._bs
    ...
    this._aq = function() {
        var q = this._cr;
        var o = new _ac(q);
        o._bq(0, 0, 9, 9);o._bq(q - 8, 0, 8, 9);o._bq(0, q - 8, 9, 8);
        ...
        o._bq(6, 9, 1, q - 17);o._bq(9, 6, q - 17, 1);
        if (this._bs > 6) {
            o._bq(q - 11, 0, 3, 6);o._bq(0, q - 11, 6, 3)
        }
        return o
    };
    this._bu = function(i) {
...
function _ax(a) {
    ...
    this._fe = (a & 7);this.__defineGetter__("_cg", function() {
        return this._cf
...
function _cg(a, c, b) {
    this._ff = a;
    this.bits = c;
    this.name = b;this.__defineGetter__("Bits", function() {
        return this.bits
...
function _dl(a, b) {
    this._dv = a;
    this._dw = b;this.__defineGetter__("_du", function() {
        return this._dv
...
function _az(b) {
    ...
    this._gi = new Array(256);var a = 1;
    for (var e = 0; e < 256; e++) {
        this._gh[e] = a;
        a <<= 1;
        if (a >= 256) {
    ...
    var d = new Array(1);
    d[0] = 0;
    this.zero = new _bp(this, new Array(d));var c = new Array(1);
    c[0] = 1;
    this.one = new _bp(this, new Array(c));this.__defineGetter__("Zero", function() {
        return this.zero
...
qrcode.vidSuccess = function(a) {
    ...
    if (qrcode.webkit) {
        ...
        if (qrcode.moz) {
            qrcode.video.mozSrcObject = a;qrcode.video.play()
        } else {
            qrcode.video.src = a
        }
    }
    ...
    if (qrcode.gUM) {
        try {
            if (qrcode.video.videoWidth == 0) {
                setTimeout(qrcode.captureToCanvas, 500);return
            } else {
                qrcode.canvas_qr2.width = qrcode.video.videoWidth;
...
qrcode.setWebcam = function(c) {
    ...
    if (d.webkitGetUserMedia) {
        qrcode.webkit = true;d.webkitGetUserMedia({
            video : a,
            audio : false
    ...
    } else if (d.mozGetUserMedia) {
        qrcode.moz = true;d.mozGetUserMedia({
            video : a,
            audio : false
        }, qrcode.vidSuccess, qrcode.vidError)
    }
};
qrcode.decode = function(d, canvas) {
...
//            var b = canvas;
        ...
        c.onload = function() {
            ...
            if (g != null) {
                ...
                j.clearRect(0, 0, 320, 240);j.drawImage(c, 0, 0, 320, 240)
            }
            ...
            i.width = l;
            i.height = f;h.drawImage(c, 0, 0, i.width, i.height);
...
function _cz(c, a, b) {
    ...
    this.y = a;
    this.count = 1;
    this._aj = b;this.__defineGetter__("_ei", function() {
        return this._aj
...
function _es(a) {
    this._go = a[0];
    this._gu = a[1];
    this._gr = a[2];this.__defineGetter__("_gp", function() {
        return this._go
...
function _cc() {
    ...
    this._am = null;this.__defineGetter__("_da", function() {
        this._al[0] = 0;
        this._al[1] = 0;
        this._al[2] = 0;
        this._al[3] = 0;
        this._al[4] = 0;return this._al
    });
    this._ao = function(f) {
        var b = 0;
        for (var d = 0; d < 5; d++) {
        ...
        for (var d = 0; d < b; d++) {
            ...
            if (a.Count >= _eg) {
                if (c == null) {
                    ...
                    this._ge = true;return Math.floor((Math.abs(c.X - a.X) - Math.abs(c.Y - a.Y)) / 2)
                }
            }
        }
        return 0
